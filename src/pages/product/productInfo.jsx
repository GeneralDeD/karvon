                ...
                <div className={st.productInfo}>
                    <div className="row">
                        <div className="col-12 col-md-3">
                            ...
                            {/*    <li><img src={carouselImg3} alt=""/> <span>{format(product.price?product.price:"123")}</span></li>*/}
                            {/*    <li><img src={carouselImg3} alt=""/> <span>{format(product.price?product.price:"123")}</span></li>*/}
                            {/*    <li><img src={carouselImg3} alt=""/> <span>{format(product.price?product.price:"123")}</span></li>*/}
                            {/*    <li><img src={carouselImg3} alt=""/> <span>{format(product.price?product.price:"123")}</span></li>*/}
                            {/*</ul>*/}
                        ...
                        <div className="col-12 col-md-9">
                            ...
                            <h1>{console.log(product.success)}</h1>
                            <div className="row">
                                {/*<div className={`col-12 col-md-6 ${st.preview}`}>*/}

                                {/*    <button className={st.chevron_left} onClick={() => slider.current.slickPrev()}>*/}
                                {/*        <i className="fa fa-fw fa-chevron-left"></i></button>*/}
                                {/*    <button className={st.chevron_right} onClick={() => slider.current.slickNext()}>*/}
                                {/*        <i className="fa fa-fw fa-chevron-right"></i></button>*/}
